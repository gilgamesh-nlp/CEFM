...
# # # Load the ROI features
train_ROI = torch.load("D:\project\CEFM-main\CEFM-main\humeme_ROI\memes_tgt/humeme_pol_train_ROI.pt")
val_ROI = torch.load("D:\project\CEFM-main\CEFM-main\humeme_ROI\memes_tgt/humeme_pol_val_ROI.pt")
test_ROI = torch.load("D:\project\CEFM-main\CEFM-main\humeme_ROI\memes_tgt/humeme_pol_test_ROI.pt")
# # # Load the attribute features
train_attr = torch.load("D:\project\CEFM-main\CEFM-main\humeme_attr\memes_tgt/humeme_pol_train_attr.pt")
val_attr = torch.load("D:\project\CEFM-main\CEFM-main\humeme_attr\memes_tgt/humeme_pol_val_attr.pt")
test_attr = torch.load("D:\project\CEFM-main\CEFM-main\humeme_attr\memes_tgt/humeme_pol_test_attr.pt")



# humeme dataset
data_dir_pol = 'D:\project\CEFM-main\CEFM-main\images'
train_path_pol = 'D:\project\CEFM-main\CEFM-main/train.jsonl'
dev_path_pol = 'D:\project\CEFM-main\CEFM-main/val.jsonl'
test_path_pol = "D:\project\CEFM-main\CEFM-main/test.jsonl"
...
preprocess = Compose([
    Resize(input_resolution, InterpolationMode.BICUBIC),
...
# VGG16 for extracting image encodings.   图像特征
...
# ##  dataset ROI+attr augmentation all return (both one-hot and numeric)

# In[ ]:


class HuMemesDatasetAug2(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        if split_flag=='train':
            ...
            self.ATTR_samples = train_attr
        elif split_flag=='val':
            self.ROI_samples = val_ROI
            self.ATTR_samples = val_attr
        else:
            self.ROI_samples = test_ROI
            self.ATTR_samples = test_attr
...
#         Process entities
        ...
        text_drob_feature = self.ATTR_samples[idx]
#         -------------------------------------------------------------------------------
...
#             Uncoment below for binary index creation
             if self.samples_frame.loc[idx, "labels"][0]=="less humor":
                 lab=0
             else:
                 lab=1
...
hm_dataset_train = HuMemesDatasetAug2(train_path_pol, data_dir_pol, split_flag='train')
dataloader_train = DataLoader(hm_dataset_train, batch_size=64,
                        shuffle=True, num_workers=0)
hm_dataset_val = HuMemesDatasetAug2(dev_path_pol, data_dir_pol, split_flag='val')
dataloader_val = DataLoader(hm_dataset_val, batch_size=64,
                        shuffle=True, num_workers=0)
hm_dataset_test = HuMemesDatasetAug2(test_path_pol, data_dir_pol, split_flag='test')
...
exp_name = "CEFM_HUMEME_Train_Eval"

exp_path = "path_to_saved_files/ModelCkpt/"+exp_name
lr=0.001
