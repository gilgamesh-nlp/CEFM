...
# POLITICAL DATA   政治数据集

# In[ ]:


# # # Load the ROI features
train_ROI = torch.load("D:\pythonproject\MOMENTA-main\MOMENTA-main\harmeme_ROI_MOMENTA\pol\memes_tgt/harmeme_pol_train_ROI.pt")
val_ROI = torch.load("D:\pythonproject\MOMENTA-main\MOMENTA-main\harmeme_ROI_MOMENTA\pol\memes_tgt/harmeme_pol_val_ROI.pt")
test_ROI = torch.load("D:\pythonproject\MOMENTA-main\MOMENTA-main\harmeme_ROI_MOMENTA\pol\memes_tgt/harmeme_pol_test_ROI.pt")
# # # Load the ENT features
train_ENT = torch.load("D:\pythonproject\MOMENTA-main\MOMENTA-main\harmeme_ENT_MOMENTA\pol\harmeme_pol_target/harmeme_pol_train_ent.pt")
val_ENT = torch.load("D:\pythonproject\MOMENTA-main\MOMENTA-main\harmeme_ENT_MOMENTA\pol\harmeme_pol_target/harmeme_pol_val_ent.pt")
test_ENT = torch.load("D:\pythonproject\MOMENTA-main\MOMENTA-main\harmeme_ENT_MOMENTA\pol\harmeme_pol_target/harmeme_pol_test_ent.pt")
...
data_dir_pol = 'D:\pythonproject\MOMENTA-main\MOMENTA-main\Harm-P\Harm-P\images'
train_path_pol = 'D:\pythonproject\MOMENTA-main\MOMENTA-main\Harm-P\Harm-P\Harm-P_JSON_50Subset/train.jsonl'
dev_path_pol = "D:\pythonproject\MOMENTA-main\MOMENTA-main\Harm-P\Harm-P\Harm-P_JSON_50Subset/val.jsonl"
test_path_pol = "D:\pythonproject\MOMENTA-main\MOMENTA-main\Harm-P\Harm-P\Harm-P_JSON_50Subset/test.jsonl"
...
#             if self.samples_frame.loc[idx, "labels"][0]=="not humor":
#                 lab=0
#             else:
#                 lab=1            
...
#     clip = 5
    ...
    # initialize early_stopping object
    chk_file = os.path.join(exp_path, 'checkpoint_'+exp_name+'.pt')
    #early_stopping = EarlyStopping(patience=patience, verbose=True, save_path=chk_file)
...
def calculate_mmae(expected, predicted, classes):
    ...
    for claz in range(NUM_CLASSES):
        class_dist = 1.0 * dist_dict[claz] / (count_dict[claz]+0.0000000000001)
        overall += class_dist
    overall /= NUM_CLASSES
    #     return overall[0]
    return overall
